...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.assignee'
        db.add_column('sodo_item', 'assignee', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='assigned_items', to=orm['sodo.User']), keep_default=False)

        # Adding field 'Item.owner'
        db.add_column('sodo_item', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='owned_items', to=orm['sodo.User']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Item.assignee'
        db.delete_column('sodo_item', 'assignee_id')

        # Deleting field 'Item.owner'
        db.delete_column('sodo_item', 'owner_id')
    ...
    models = {
        ...
        'sodo.item': {
            ...
            'assignee': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'assigned_items'", 'to': "orm['sodo.User']"}),
