...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('sodo_item', 'user_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'Item.user'
        db.add_column('sodo_item', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='items', to=orm['sodo.User']), keep_default=False)
